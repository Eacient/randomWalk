...
def parse_args():
    ...
    parser.add_argument('--datalist', default='metadata/voc12/train_aug.txt', type=str)
    parser.add_argument('--gt_dir', default='/home/dogglas/mil/datasets/VOC2012/SegmentationClassAug', type=str)
    parser.add_argument('--pred_dir', default='output/cam_png', type=str)
    parser.add_argument('--save_path', default='output/detail.log', type=str)
